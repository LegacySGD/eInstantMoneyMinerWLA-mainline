...
public class MoneyMinerWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(MoneyMinerWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/MoneyMinerWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/MoneyMinerWLAIW/InitOutcome.xml").getDocumentElement();
